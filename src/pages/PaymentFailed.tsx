      ...
      <Card className="w-full max-w-md border-none shadow-lg">
        <CardHeader className="text-center pb-2 bg-gradient-to-r from-theme-primary/10 to-theme-accent/10 rounded-t-lg">
          <div className="flex justify-center mb-2">
            <div className="h-16 w-16 rounded-full bg-destructive/10 flex items-center justify-center animate-pulse-gentle">
        ...
        <CardContent className="py-4">
          <ul className="space-y-3">
            {possibleReasons.map((reason, index) => (
              <li key={index} className="flex items-start bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100 animate-float">
        ...
        <CardFooter className="flex flex-col space-y-3 bg-gradient-to-r from-theme-primary/5 to-theme-accent/5 rounded-b-lg">
          <Button asChild className="w-full bg-theme-primary hover:bg-theme-primary/90 shadow-md hover:shadow-lg transition-shadow">
